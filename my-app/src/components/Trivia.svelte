...
<div>
    <h1 class="mt-20 text-2xl font-extrabold flex justify-center text-gray-900 dark:text-white md:text-2xl lg:text-4xl"><span class="text-transparent pb-10 bg-clip-text bg-gradient-to-r to-emerald-500 from-sky-300">TriviaSpel! Utformat för alla åldrar</span></h1>
    {#if !quizStarted}
        {#if !questionType}
